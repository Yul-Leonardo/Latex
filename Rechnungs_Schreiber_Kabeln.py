...
def python_to_latex(tag, monat, jahr, tage, bezeichnung, betrag):
    with open("Pdf Dateien/name_rechnung_kabeln.tex","w") as file:
        ...
        file.write('Z\"OPHEL GmbH\\\ \n')
        file.write('K\"uchenmeisteralle 109\\\ \n')
        file.write('D- 15711 K\"onigs W\"usterhausen\\\ \n')
        file.write('\n')
        ...
        file.write('Ich erlaube mir, meine medientechnischen Dienstleistungen,\\\ \n')
